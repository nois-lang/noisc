use crate::ast::ast::{AstPair, Operand};
use crate::ast::util::custom_error_span;
use crate::interpret::context::Scope;
use crate::interpret::value::Value;
use crate::parser::Rule;
use pest::error::Error;

pub trait Evaluate {
    fn eval(&self, scope: &mut Scope) -> Result<Value, Error<Rule>>;
}

impl Evaluate for AstPair<Operand> {
    fn eval(&self, _scope: &mut Scope) -> Result<Value, Error<Rule>> {
        match &self.1 {
